...
public class GLView extends GLSurfaceView
{
    ...
    {
        super(context);
        setEGLContextFactory(new ContextFactory());                                         // Install a custom EGLContextFactory.
    ...
    private static class ContextFactory implements GLSurfaceView.EGLContextFactory
    {
        ...
        {
            egl.eglDestroyContext(display, context);                                             // 释放Context相关的资源
        }
    }
    ...
    private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser
    {
        public EGLConfig chooseConfig(EGL10 egl, EGLDisplay display)
        {
            ...
            egl.eglChooseConfig(display, attrib, null, 0, num_config);                   // 获取一个Display与指定属性相匹配的Config列表
            ...
            egl.eglChooseConfig(display, attrib, configs, numConfigs,num_config);       // 获取一个Display与指定属性相匹配的Config列表
